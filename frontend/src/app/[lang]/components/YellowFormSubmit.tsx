...
export default function YellowFormSubmit({
  placeholderEmail,
  ...
  return (
    <div className="form_group_reg flex flex-row items-center lg:self-center lg:justify-center flex-shrink-0 lg:justify-end">
        ...
        <>
          <div className="flex flex-col"> 
            <input
              ...
              value={email}
              className="w-full p-3 bg-yellow-field dark-placeholder  mb-3"   
              />
          <input
  type="text"
...
/>
          ...
          <button
            type="button"
            className="btn_submit p-3 custom-font-book font-spacing button-bg-black text-white uppercase"
